...
export class Web3Service {
  ...
  private checkAndRefreshWeb3() {
    ...
    if (this.windowRef.nativeWindow) {
        ...
        if(this.windowRef.nativeWindow.web3 && this.windowRef.nativeWindow.web3.currentProvider){
        ...
        if (typeof this.MetaCoin.currentProvider.sendAsync !== "function") {
          let c =  this.MetaCoin;
  this.MetaCoin.currentProvider.sendAsync = function() {
